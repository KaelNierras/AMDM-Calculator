...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _calculate() {
    ...
    //Point Load & Inverted Varying Combination 2 spans
    if (selectedLoadType == 'Point Load' &&
      ...
      //Calculating FEM BC1
      femB1 = (twospanLoadBCData * ((lengthBC) * (lengthBC))) / (20);
      if (femB1 > 0) {
        femB1 = -femB1;
      }
      print(
      ...
      //Calculating FEM BC2
      femB2 = (twospanLoadBCData * ((lengthBC) * (lengthBC))) / (30);
      femB2 = femB2.abs();
    ...
    //Uniformly Distributed & Point Load Combination 2 spans
    if (selectedLoadType == 'Uniformly Distributed' &&
        selectedLoadType2 == 'Point Load') {
      String inputAB = _lengthControllerAB.text;
      String inputBC = _lengthControllerBC.text;
      ...
      //Convert Values from Input BC to double
      double twospanLoadBCData = double.tryParse(twospanLoadBCInput) ?? 0;
      double twospanLlBCData = double.tryParse(twospanLlBCInput) ?? 0;
      ...
      //Calculating FEM AB1
      femA1 = (twospanLoadABData * ((lengthAB) * (lengthAB))) / (12);
      if (femA1 > 0) {
        femA1 = -femA1;
      }

      //Calculating FEM AB2
      femA2 = (twospanLoadABData * ((lengthAB) * (lengthAB))) / (12);
      femA2 = femA2.abs();
    ...
    //Uniformly Distributed & Uniformly Distributed Combination 2 spans
    if (selectedLoadType == 'Uniformly Distributed' &&
        selectedLoadType2 == 'Uniformly Distributed') {
      String inputAB = _lengthControllerAB.text;
      String inputBC = _lengthControllerBC.text;
    ...
    //Uniformly Distributed & Varying Combination 2 spans
    if (selectedLoadType == 'Uniformly Distributed' &&
    ...
    //Uniformly Distributed & Inverted Varying Combination 2 spans
    if (selectedLoadType == 'Uniformly Distributed' &&
        selectedLoadType2 == 'Inverted Varying') {
      String inputAB = _lengthControllerAB.text;
      String inputBC = _lengthControllerBC.text;
    ...
    //Varying & Point Load Combination 2 spans
    if (selectedLoadType == 'Varying' && selectedLoadType2 == 'Point Load') {
      String inputAB = _lengthControllerAB.text;
      String inputBC = _lengthControllerBC.text;
      ...
      //Calculating FEM AB1
      femA1 = (twospanLoadABData * ((lengthAB) * (lengthAB))) / (30);
      if (femA1 > 0) {
        femA1 = -femA1;
      }

      //Calculating FEM AB2
      femA2 = (twospanLoadABData * ((lengthAB) * (lengthAB))) / (20);
      femA2 = femA2.abs();
    ...
    //Varying & Uniformly Distributed Combination 2 spans
    if (selectedLoadType == 'Varying' &&
        selectedLoadType2 == 'Uniformly Distributed') {
      String inputAB = _lengthControllerAB.text;
      String inputBC = _lengthControllerBC.text;
    ...
    //Varying & Inverted Varying Combination 2 spans
    if (selectedLoadType == 'Varying' && selectedLoadType2 == 'Varying') {
      String inputAB = _lengthControllerAB.text;
      String inputBC = _lengthControllerBC.text;
    ...
    //Inverted Varying & Point Load Combination 2 spans
    if (selectedLoadType == 'Inverted Varying' &&
        selectedLoadType2 == 'Point Load') {
      String inputAB = _lengthControllerAB.text;
      String inputBC = _lengthControllerBC.text;
      ...
      //Calculating FEM AB1
      femA1 = (twospanLoadABData * ((lengthAB) * (lengthAB))) / (20);
      if (femA1 > 0) {
        femA1 = -femA1;
      }

      //Calculating FEM AB2
      femA2 = (twospanLoadABData * ((lengthAB) * (lengthAB))) / (30);
      femA2 = femA2.abs();
